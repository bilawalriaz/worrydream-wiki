...
*   **Backus 1978 (FP):** Both Backus and the Self team are driven by a quest for **simplicity and mathematical purity** as a source of power. Backus sought it in functional, variable-free programming; Self sought it in a pure, uniform object model where everything is a message send. Both critiques stem from a dissatisfaction with the complexity and ad-hoc nature of contemporary languages.
*   **Hoare 1973 (The Emperor's Old Clothes):** Ungar explicitly cites Hoare's call for simplicity as an aesthetic influence. The Self language's small size and uniformity are attempts to follow this ideal, contrasting with the growing complexity of languages like C++.
*   **Lockhart 2002 (A Mathematician's Lament):** While about mathematics, Lockhart's core argument—that the soul of a discipline (creativity, exploration) is killed by an overemphasis on rigid procedure and assessment—resonates with Self's goal. Self was designed to allow programming to be more like an exploratory, creative "physics" and less like a formal, prescriptive chore.
...
3.  > *"The computer is a blank canvas upon which programmers write their own laws of physics."* (Smith, quoted by Ungar)
