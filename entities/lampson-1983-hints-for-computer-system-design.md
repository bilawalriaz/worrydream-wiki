...
*   **Operating Systems and Distributed Systems:** The hints about interface stability ("Keep basic interfaces stable"), performance ("Make it fast," "Use brute [[air-force-1960-air-force-office-of-scientific-research|force]]"), and fault tolerance ("End-to-end," "Log updates") directly shaped the design philosophy of systems from Unix to modern cloud infrastructures.
...
*   **[[engelbart-1960-games-that-teach-the-fundamentals-of-computer-operation|Engelbart]] (1962, *Augmenting Human Intellect*):** Both address the design of complex systems for human use. [[engelbart-1960-games-that-teach-the-fundamentals-of-computer-operation|Engelbart]] focuses on the *goal* (augmenting human intellect), while Lampson focuses on the *how* (pragmatic design hints to achieve robust functionality).
...
*   **[[backus-1978-can-programming-be-liberated-from-the-von-neumann-style|Backus]] (1978, *FP*):** While opposing in style ([[backus-1978-can-programming-be-liberated-from-the-von-neumann-style|Backus]] is revolutionary, Lampson is evolutionary), both share a deep concern with complexity. [[backus-1978-can-programming-be-liberated-from-the-von-neumann-style|Backus]] attacks it at the level of programming language semantics; Lampson combats it at the level of system construction and interface definition.
*   **[[feynman-1974-cargo-cult-science|Feynman]] (1974, *Cargo Cult Science*):** Lampson's disclaimer—"These are not... guaranteed to work"—and his emphasis on learning from building and failing aligns with Feynman's call for genuine scientific integrity over performative adherence to ritual. Lampson's hints are the antithesis of cargo cult design.
*   **[[thurston-1990-mathematical-education|Thurston]] (1994, *Proof and Progress*):** [[thurston-1990-mathematical-education|Thurston]] discusses the social and communicative aspects of mathematical progress. Lampson does the same for system design, showing how shared "folk wisdom" and a common language of slogans enable a community of practitioners to make progress.
