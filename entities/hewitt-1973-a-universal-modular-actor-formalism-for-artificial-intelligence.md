...
*   **Theoretical Computer Science:** It provided a formal, operational semantics for concurrency based on message-passing, complementing the formalisms of CSP ([[hoare-1981-the-emperors-old-clothes|Hoare]]) and π-calculus (Milner).
...
*   **Douglas [[engelbart-1960-games-that-teach-the-fundamentals-of-computer-operation|Engelbart]] (1962, "Augmenting Human Intellect"):** While different in focus, both envision computation as a medium for augmenting human thought. Hewitt's actor model provides a possible *implementation substrate* for the kind of dynamic, interconnected "knowledge boxes" [[engelbart-1960-games-that-teach-the-fundamentals-of-computer-operation|Engelbart]] envisioned. The actor's "intention" mechanism relates to Engelbart's emphasis on structured, explicit representation of goals.
...
*   **Seymour [[papert-1980-mindstorms-1st-ed|Papert]] (1980, "Mindstorms"):** Hewitt explicitly links his model to Papert's "little man" model of LOGO, generalizing it to a "cooperating society." Both emphasize learning and modularity; the actor model can be seen as a formalization of the agent-based, turtle-graphics world [[papert-1980-mindstorms-1st-ed|Papert]] popularized in education.
*   **P.W. [[anderson-1972-more-is-different|Anderson]] (1972, "More is Different"):** Anderson's argument about emergent properties in physics resonates with Hewitt's vision. Complex AI behaviors and global synchronization properties are not programmed explicitly but *emerge* from the local interactions (message-passing) of simple actors.
