...
*   **[[bush-1931-the-differential-analyzer|Bush]] 1945 (As We May Think):** Both papers envision technology augmenting human intellect and connection, but Hollan & Stornetta are more focused on the *quality and nature* of the communication medium itself, critiquing the direct simulation Bush's Memex could imply.
...
*   **[[backus-1978-can-programming-be-liberated-from-the-von-neumann-style|Backus]] 1978 (FP) & [[lockhart-2002-a-mathematicians-lament|Lockhart]] 2002 (Mathematician's Lament):** These connections are more abstract but profound. Both are critiques of a dominant paradigm (imperative programming; math-as-routine-calculation) that mistake the vehicle for the goal. Hollan et al. make the same move for communication, arguing we've mistaken the vehicle (face-to-face medium) for the goal (communication needs).
*   **[[anderson-1972-more-is-different|Anderson]] 1972 (More is Different):** Anderson's argument about emergent complexity at different scales is relevant. The "needs" of communication exist at a high psychological/social level; the "mechanisms" emerge from the properties of a specific medium at a lower level. You cannot understand good mechanisms by simply aggregating properties of a different medium.
