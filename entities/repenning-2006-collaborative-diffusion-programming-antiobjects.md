...
*   **Seymour [[papert-1980-mindstorms-1st-ed|Papert]] (Mindstorms, 1980):** This is the strongest connection. Repenning’s work is deeply Papertian. [[papert-1980-mindstorms-1st-ed|Papert]]’s "body syntonicity" is exactly the concept Repenning identifies as the barrier to antiobject thinking. The paper is an argument for a new "object to think with" that transcends the limits of the physical body metaphor, echoing [[papert-1980-mindstorms-1st-ed|Papert]]’s constructionist learning theory.
*   **Douglas [[hofstadter-2001-analogy-as-core-of-cognition|Hofstadter]] (Analogy, 2001):** The entire paper is an exercise in breaking a bad analogy (objects must behave like physical objects) and proposing a new, more productive one (computation can be diffused across a medium). It’s about the power of shifting analogical frameworks to solve problems.
*   **Christopher [[alexander-1965-a-city-is-not-a-tree|Alexander]] (via Software Design Patterns):** While not in the list, the paper challenges the notion that "patterns" in software should mirror patterns in the physical world. It suggests some computational patterns are best served by *inverting* the physical analogy.
*   **John [[backus-1978-can-programming-be-liberated-from-the-von-neumann-style|Backus]] (FP, 1978):** There is a distant kinship in the spirit of rejecting the status quo. Just as [[backus-1978-can-programming-be-liberated-from-the-von-neumann-style|Backus]] challenged the von Neumann imperative style of programming, Repenning challenges the imperative, actor-centric style of OOP for certain classes of problems, proposing a declarative, field-based computation instead.
*   **Contrast with [[engelbart-1960-games-that-teach-the-fundamentals-of-computer-operation|Engelbart]] (1962) and [[bush-1931-the-differential-analyzer|Bush]] (1945):** Those works are about augmenting human intellect and managing information. Repenning’s work is about augmenting *computational* design by rethinking the very ontology of the agents that make up a system. It’s a meta-tool for the designer.
