...
1.  **Direct Lineage in Analog Computing:** It became the archetype for analog computers for the next two decades. It directly inspired similar machines at the [[moore-1966-autotelic-responsive-environments-and-exceptional-children|Moore]] School (used for artillery firing tables), Cambridge, and elsewhere. This lineage dominated high-speed computation for engineering until the digital computer became practical.
