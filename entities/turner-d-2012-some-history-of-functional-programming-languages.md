...
*   **[[bush-1931-the-differential-analyzer|Bush]] 1945 (As We May Think):** Both deal with tools that augment human thought. Bush's Memex is a hypertext system; functional programming provides a mathematical tool for clear, composable thought about computation. The connection is the pursuit of powerful symbolic tools for the mind.
*   **[[backus-1978-can-programming-be-liberated-from-the-von-neumann-style|Backus]] 1978 (FP):** This is the most direct connection. Turner's paper explains the historical context that led to, and was superseded by, the functional programming paradigm [[backus-1978-can-programming-be-liberated-from-the-von-neumann-style|Backus]] advocated for in his [[turing-1936-on-computable-numbers-with-an-application-to-the-entscheidungsproblem|Turing]] Award lecture. Haskell is the practical realization of the ideals [[backus-1978-can-programming-be-liberated-from-the-von-neumann-style|Backus]] championed.
...
*   **[[thurston-1990-mathematical-education|Thurston]] 1994 (Proof and Progress):** [[thurston-1990-mathematical-education|Thurston]] discusses the social and cognitive aspects of mathematical progress. Turner's narrative can be seen as a parallel in computer science: a community converging on an aesthetic (the elegance of pure, lazy functional programming) and a set of agreed-upon problems to solve.
