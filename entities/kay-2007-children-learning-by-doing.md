...
1.  **LOGO ([[papert-1980-mindstorms-1st-ed|Papert]], 1960s-70s):** The foundational constructionist environment where children program a "turtle" to explore geometry. Etoys' scripting is a direct descendant, but generalized to any object with a "costume."
2.  **Smalltalk (Kay et al., 1970s at Xerox [[parc-1971-parc-papers-for-pendery-and-planning-purposes|PARC]]):** The dynamic, object-oriented programming environment where everything is a live object. Etoys is built *on* Squeak (an open-source Smalltalk), making the entire system reflective and malleable.
...
The problem being solved was twofold: providing a software platform appropriate for the OLPC's educational mission, and more fundamentally, advancing the decades-old dream (held by Kay, [[papert-1980-mindstorms-1st-ed|Papert]], and others) of using computers to fundamentally reshape how children think about complex ideas.
...
*   **[[papert-1980-mindstorms-1st-ed|Papert]] 1980 (Mindstorms):** The foundational text for the constructionist philosophy that Etoys operationalizes. Papert's "turtle geometry" becomes any object's trajectory; his vision of children as scientists is enabled by Etoys' simulation capacity.
*   **[[bush-1931-the-differential-analyzer|Bush]] 1945 (As We May Think):** Kay's vision of a "meta-medium" where one can create, connect, and simulate ideas echoes Bush's memex, but with the crucial addition of *dynamic behavior*. Etoys is a memex where the trails are executable scripts.
*   **[[engelbart-1960-games-that-teach-the-fundamentals-of-computer-operation|Engelbart]] 1962 (Augmenting Human Intellect):** Both are focused on using computers to enhance human cognitive capabilities, but Engelbart's vision was largely for knowledge workers. Kay's paper radicalizes this by aiming for the cognitive development of children.
*   **[[backus-1978-can-programming-be-liberated-from-the-von-neumann-style|Backus]] 1978 (FP):** Kay's dismissal of "textual syntax" in favor of visual, combinational tile-building is a direct response to the problems of conventional programming languages that [[backus-1978-can-programming-be-liberated-from-the-von-neumann-style|Backus]] also critiqued, albeit from a purely functional perspective.
*   **[[hofstadter-2001-analogy-as-core-of-cognition|Hofstadter]] 2001 (Analogy):** The Etoys environment is a powerful tool for creating analogical models. A child scripting an ant following a pheromone gradient is building a concrete, executable analogy for diffusion processes.
*   **[[lockhart-2002-a-mathematicians-lament|Lockhart]] 2002 (Mathematician's Lament):** Both Kay and [[lockhart-2002-a-mathematicians-lament|Lockhart]] lament the formalistic, symbolic-only teaching of mathematics. Etoys offers a path out, by allowing children to *experience* mathematical ideas (vectors, probability, systems dynamics) through construction and play.
