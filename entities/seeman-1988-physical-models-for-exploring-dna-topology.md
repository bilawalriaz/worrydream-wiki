...
*   **Thurston 1994 ("On Proof and Progress in Mathematics"):** Thurston describes mathematics as a deeply human, visual, and intuitive endeavor, where progress is measured by the deepening of understanding, not just the accumulation of theorems. Seeman's models embody this philosophy for molecular biology: the goal is to develop a "physical intuition" for topology. The models are tools for building the kind of understanding Thurston describes, making abstract linking concepts tangible.
