...
*   **Backus 1978 (FP):** Backus criticizes the von Neumann bottleneck and advocates for a higher-level, functional style of programming. This is, in a sense, a proposal for a more "appropriate" representation for certain kinds of computation, echoing Amarel's core insight that changing representation transforms problem difficulty.
*   **Thurston 1994 (Proof and Progress):** Thurston describes the creative, communicative, and often non-linear process of mathematical understanding. Amarel seeks the operational principles underlying such processes, specifically the part where a mathematician "finds the right framework" for a proof, which is the creative act Thurston describes from the inside.
