...
*   **The Personal Computer Ideal:** FLEX’s specification for a low-cost, desk-top machine with integrated software is a direct blueprint for the personal computer concept Kay would later champion at Xerox [[parc-1971-parc-papers-for-pendery-and-planning-purposes|PARC]] and Apple.
...
*   **[[engelbart-1960-games-that-teach-the-fundamentals-of-computer-operation|Engelbart]] 1962 (Augmenting Human Intellect):** FLEX is a concrete technical implementation of [[engelbart-1960-games-that-teach-the-fundamentals-of-computer-operation|Engelbart]]’s high-level goals. Where [[engelbart-1960-games-that-teach-the-fundamentals-of-computer-operation|Engelbart]] describes a conceptual framework for augmenting human capability, Kay engineers a system that realizes key aspects: an interactive, language-based environment for complex thought and problem-solving.
