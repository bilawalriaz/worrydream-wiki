...
*   **[[bush-1931-the-differential-analyzer|Bush]] 1945 (As We May Think):** Bush's memex is a vision of associative memory and trail-based navigation. Lisp's list structures can be seen as a concrete, programmable implementation of this associative, symbolic linking. Both envision augmenting human thought by externalizing and linking ideas.
...
*   **[[backus-1978-can-programming-be-liberated-from-the-von-neumann-style|Backus]] 1978 (FP):** Backus's [[turing-1936-on-computable-numbers-with-an-application-to-the-entscheidungsproblem|Turing]] Award lecture critiques the "vicious cycle" of von Neumann architectures and proposes a purely functional, algebraic language (FP) as a cure. McCarthy's paper presents Lisp as an earlier, practical attempt to escape this cycle, using algebraic function composition as its core. The two papers are complementary visions of programming's mathematical ideal.
*   **[[papert-1980-mindstorms-1st-ed|Papert]] 1980 (Mindstorms):** Papert's constructionist learning theory relied on Logo, a language derived from Lisp. Lisp's simplicity, recursive structure, and direct manipulability of symbols made it the ideal base for a language intended to be a "womb" for children's ideas about computation.
*   **[[thurston-1990-mathematical-education|Thurston]] 1994 (Proof and Progress):** [[thurston-1990-mathematical-education|Thurston]] describes mathematics as a social process of building understanding. McCarthy's account of Lisp's creation mirrors this: a core set of intuitive ideas (understanding) being formalized and pruned to achieve "mathematical neatness," which in turn enabled new forms of understanding (program correctness, formal semantics).
...
*   **The Value of Formal Foundations:** McCarthy's push for "mathematical neatness" presaged the formal verification movement. The idea that a clean, minimal language semantics makes programs easier to reason about and [[mueller-prove-2002-vision-and-reality-of-hypertext|prove]] correct is a cornerstone of reliable systems engineering today.
