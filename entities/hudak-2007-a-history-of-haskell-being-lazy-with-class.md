...
*   **[[backus-1978-can-programming-be-liberated-from-the-von-neumann-style|Backus]] 1978 (FP):** Haskell is the most significant long-term successor to the ideals [[backus-1978-can-programming-be-liberated-from-the-von-neumann-style|Backus]] championed. The paper directly references [[backus-1978-can-programming-be-liberated-from-the-von-neumann-style|Backus]] as a founding inspiration, framing Haskell as the realization of a "functional programming" vision that broke from von Neumann limitations.
