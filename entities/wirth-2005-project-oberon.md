...
*   **[[bush-1931-the-differential-analyzer|Bush]] 1945 (As We May Think):** Both envision a personalized, integrated information workstation. [[bush-1931-the-differential-analyzer|Bush]]’s Memex is a tool for thought augmentation; Oberon is a concrete, minimal implementation of the *computer* that could host such a system, emphasizing that the tool itself must be understandable to be truly effective.
...
*   **[[backus-1978-can-programming-be-liberated-from-the-von-neumann-style|Backus]] 1978 (FP - Can Programming Be Liberated?):** [[backus-1978-can-programming-be-liberated-from-the-von-neumann-style|Backus]] attacks the "word-at-a-time" imperative tradition, advocating for functional programming. Wirth, while working within the imperative tradition, shares [[backus-1978-can-programming-be-liberated-from-the-von-neumann-style|Backus]]’s goal of achieving clarity and correctness through formalism. Oberon can be seen as a highly disciplined, practical application of the principle that a clear formalism is paramount.
