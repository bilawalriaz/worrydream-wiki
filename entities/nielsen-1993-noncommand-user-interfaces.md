...
*   **[[papert-1980-mindstorms-1st-ed|Papert]] 1980 (Mindstorms):** Papert's constructionism advocates for children to control computers through intuitive programming (LOGO). Nielsen's "noncommand" interfaces take this further, removing even the need for explicit programming syntax in many cases, making the computer adapt to the user's *actions*.
