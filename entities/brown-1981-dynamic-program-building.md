...
4.  **Precedent in Interactive Systems:** Smalltalk ([[ingalls-1978-the-smalltalk-76-programming-system|Ingalls]], 1978) was already promoting a more object-oriented, dynamic perspective. Systems like PL/CS and LC2 allowed runtime modification. Brown sought to radicalize this by making dynamic building the *only* construction mode, not an optional feature.
...
*   **[[vannevar-bush-symposium-1995-closing-panel|Vannevar]] [[bush-1931-the-differential-analyzer|Bush]] (1945, As We May Think):** Connects on the theme of augmenting human intellect by creating a more fluid, associative interface with knowledge and tools. Bush’s Memex is for information, Brown’s Build is for code—a dynamic, traceable object.
...
*   **Seymour [[papert-1980-mindstorms-1st-ed|Papert]] (1980, Mindstorms):** Strong resonance with the constructionist learning philosophy. [[papert-1980-mindstorms-1st-ed|Papert]] argued that children learn best by building external objects. Brown’s system makes the program itself that external, dynamically built object, with the computer as the reactive partner in the constructionist dialogue.
*   **William [[thurston-1990-mathematical-education|Thurston]] (1994, Proof and Progress):** The connection is philosophical. [[thurston-1990-mathematical-education|Thurston]] emphasizes that mathematics is a social, communicative activity involving shared understanding of objects. Brown’s dynamic building is a method for constructing programs (a formal object) in a way that fosters deep, immediate understanding of its behavior, akin to [[thurston-1990-mathematical-education|Thurston]]’s "experience of understanding."
