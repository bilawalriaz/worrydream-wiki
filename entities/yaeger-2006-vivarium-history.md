...
*   **[[bush-1931-the-differential-analyzer|Bush]] 1945 (As We May Think):** The concept of a personal, associative "memex" finds a new expression in the Vivarium's vision of a personal ecology of agents that can curate and retrieve information, making the memex proactive rather than passive.
*   **[[papert-1980-mindstorms-1st-ed|Papert]] 1980 (Mindstorms):** The connection is methodological and philosophical. Both Papert's constructionism (children learning through building) and the Vivarium's approach of learning *from* children building digital ecosystems are two sides of the same coin: using computation to understand and extend thinking.
