...
*   **From Landauer (1961)** → **Bennett (1973)**: The second correction (computation can avoid erasure, hence be arbitrarily cheap).
*   **From Bennett** → **Benioff, Feynman, and the birth of quantum computing**: The paper notes that Bennett's reversible computation was a key idea presented at the 1981 MIT workshop where Feynman conceived of quantum simulation.
...
3.  > "Charles Bennett’s paper...which Wheeler and Zurek have labelled epoch-making. In particular, I had assumed (quite incorrectly), that a computation which runs along a chain of 1:1 transformations is a table look-up device, where the designer has to anticipate every possible computational trajectory."
...
5.  > "I did not believe or understand Charles [Bennett] when he first explained his emerging notions to me, in 1971. It took me some months to come to understanding and agreement."
