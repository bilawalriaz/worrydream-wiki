...
4.  **Identification of the Decisive Factor:** He pinpoints that the victory of Gibbs-Heaviside notation was secured not by a single proof, but by its adoption in influential textbooks (like Wilson’s *Vector Analysis*, based on Gibbs’s lectures) and by its superior pedagogical manageability. It gave physicists and engineers the tools they needed without the abstract overhead of quaternions or Grassmannian algebra.
