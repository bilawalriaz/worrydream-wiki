...
3.  **Advances in [[armstrong-2003-making-reliable-distributed-systems-in-the-presence-of-software-errors|Distributed Systems]] & Fault Tolerance:** Work on Byzantine fault tolerance and consensus algorithms (e.g., [[lamport-2003-the-future-of-computing-logic-or-biology|Lamport]]'s work) acknowledged the problem of unreliable components but still often assumed a relatively small, known set of participants.
...
## Influence
The influence of th[[armstrong-2003-making-reliable-distributed-systems-in-the-presence-of-software-errors|is paper is deep an]]d widespread, though often indirect, having seeped into the culture of distributed systems and [[hamming-1968-one-mans-view-of-computer-science|computer science]] philosophy:
...
3.  **Sensor Networks and IoT:** The paradigms for in-network computation and data aggregation in massive sensor networks borrow heavily from amorphous computing's philosophy of local communic[[hamming-1968-one-mans-view-of-computer-science|ation and emerge]]nt global state.
...
*   **[[anderson-1972-more-is-different|Anderson 1972]] (More is Different):** This is the most profound connection. [[anderson-1972-more-is-different|Anderson]]'s argument that each level of complexity requires entirely new fundamental concepts is the philosophical backbone of Abelson's work. Amorphous computing is a direct attempt to find the "different" principles needed to manage the complexity of a million-node ensemble, which cannot be[[armstrong-2003-making-reliable-distributed-systems-in-the-presence-of-software-errors| understood by scal]]ing up the principles of single-node programming.
*   **[[feynman-1974-cargo-cult-science|Feynman 1974]] (Cargo [[feynman-1974-cargo-cult-science|Cult Science]]):** The paper is a warning against the "[[feynman-1974-cargo-cult-science|cargo cult]]" approach to massive distributed systems—merely sprinkling parallel processing keywords onto a program and expecting it to work. True understanding requires grappling with the new fundamental phenomena (asynchrony, anonymity, emergence) that appear at scale.
*   **[[backus-1978-can-programming-be-liberated-from-the-von-neumann-style|Backus 1978]] (FP):** Both papers argue for a radical shift in programming paradigm to handle new challenges. [[backus-1978-can-programming-be-liberated-from-the-von-neumann-style|Backus]] argues for [[hughes-1990-why-functional-programming-matters|functional programming]] to manage complexity and enable reasoning in sequential programs; Abelson argues for an emergent, local-interaction paradigm to manage the chaos of massive decentralization. Both see the existing paradigm as a fundamental bottleneck.
*   **[[engelbart-1962-augmenting-human-intellect-typeset|Engelbart 1962]] ([[engelbart-1962-augmenting-human-intellect|Augmenting Human]] Intellect):** [[engelbart-2003-improving-our-ability-to-improve|Engelbart]]'s focus is on augmenting the *human* individual. Amorphous computing can be seen as an attempt to augment the *collective*, creating computational substrates that can serve as a new kind of "organism" or environment for human thought and action.
*   **[[lockhart-2002-mathematicians-lament|Lockhart 2002]] (Mathematician's Lament):** There is a shared lament. [[lockhart-2002-mathematicians-lament|Lockhart]] decries the sterilization of mathematics; Abelson decries the sterile, top-down nature of conventional programming for large-scale systems. Both call for a return to a more organic, exploratory, and pattern-based way of thinking.
