...
*   **Feynman 1974 (Cargo Cult Science):** Feynman criticized science that follows the form of research without its substance. Mead’s critique of the digital computing paradigm—spending 10¹³ times more energy than necessary by "shoveling bits around"—can be seen as a description of a cargo cult approach to computation: following the ritual of digital logic without engaging with the underlying physics of efficient computation.
...
*   **The Limits of Moore’s Law:** With transistor scaling slowing, performance gains must come from architectural innovation. Mead’s paper champions the brain-inspired architectural revolution as the primary source of future gains.
