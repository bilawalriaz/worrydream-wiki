...
## Methodology
The methodology is **constructive and argumentative**. Maloney and [[smith-r-1987-experiences-with-the-alternate-reality-kit-an-example-of-the-tension-between-literalism-and-magic|Smith]] do not present empirical studies with users. Instead, they:
1.  **Articulate a [[clark-d-1988-the-design-philosophy-of-the-darpa-internet-protocols|Design Philosophy]]:** Ground the principles of directness and liveness in the intuitive model of physical reality.
...
This is a classic "systems paper" from the HCI and [[borning-1981-the-programming-language-aspects-of-thinglab|programming language]] communities, where the creation of a novel, coherent system is itself the primary research contribution and argument.
...
*   **[[engelbart-2003-improving-our-ability-to-improve|[[engelba]]rt-1962-augmenting-human-intellect-typeset|[[engelbart-1962-augmenting-human-intellect-typeset|Engelbart]] 1962]] (Augmenting [[engelbart-1962-augmenting-human-intellect|Human Intellect]]):** Morphic is a concrete implementation of [[engelbart-1962-augmenting-human-intellect-typeset|Engelbart]]'s vision for a system where humans manipulate symbols directly. His concept of a "H-LAM/T" (Human using Language-Artifacts-Methodology, in which he is Trained) is exemplified by Morphic, where the artifact (the UI) is both the product and the [[kay-2013-what-is-a-dynabook|med]]ium o[[kay-2013-what-is-a-dynabook|f m]]anipulation.
*   **[[kay-1972-personal-computer-for-children|Kay 1972]] ([[kay-1972-a-personal-computer-for-children-of-all-ages|Personal Computer]]):** [[kay-1968-flex-a-flexible-extendable-language|Kay]]'s Dynabook vision included children creating dynamic simulations and media. Morphic's directness and liveness are the[[kay-2013-what-is-a-dynabook| te]]chnical realization of the kind of direct, creative en[[kay-2013-what-is-a-dynabook|gag]]ement with computational ideas that [[kay-1968-flex-a-flexible-extendable-language|Kay]] envisioned. The paper is a direct intellectual descendant of the Smalltalk tradition [[kay-1968-flex-a-flexible-extendable-language|Kay]] founded.
*   **[[papert-1980-mindstorms-1st-ed|Papert 1980]] (Mindstorms):** [[papert-2000-whats-the-big-idea-toward-a-pedagogy-of-idea-power|Papert]]'s constructionism—the idea that learning happens best when you are actively building artifacts—is powerfully served by Morphic. Etoys, built on Morphic, is perhaps the purest example of [[papert-1980-mindstorms|Papert]]'s ideas applied to software, where[[engelbart-2003-improving-our-ability-to-improve| the "bod]]y of knowledge" is the living, malleable system itself.
*   **[[bush-1945-as-we-may-think-with-engelbart-notes|Bush 1945]] (As We May Think):** Morphic realizes [[vannevar-bush-symposium-1995-closing-panel|Bush]]'s concept of the "memex" as a system where associations are created and navigated not just by linking documents, but by directly manipulating the structure of the interface and the information displays themselves in a continuous workspace.
...
4.  **Education:** As seen in Etoys, Morphic remains a gold standard for constructionist learning enviro[[hutchins-1985-direct-manipulation-interfaces|nments. Modern educ]]ational coding platforms (like Swift Playgrounds) incorporate live preview and direct manipulation, but rarely with the radical openness and reifiability of Morphic's full object world.
